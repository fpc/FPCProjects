...
Legal issues: Copyright (C) 1999-2003 by François PIETTE
...
const
  CopyRight : String     = 'WebServ (c) 1999-2003 F. Piette V1.04 ';
...
begin
    ...
    else if CompareText(THttpConnection(Client).Path, '/redir.htm') = 0 then
