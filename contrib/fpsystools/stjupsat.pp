 ...
 * ***** END LICENSE BLOCK ***** *)
 ...
 Tom Lisjac <vlx@users.sourceforge.net> http://theseus.sf.net
   ...
   17-6-2003 status: compiled perfectly with no changes... ready to test

 *)

{*********************************************************}
{* TurboPower SysTools for Kylix: StJupsat.pas 1.01      *}
{*********************************************************}
{* SysTools: Astronomical Routines for the "Gallilean"   *}
{*           Satellites of Jupiter: Ganymede, Europa,    *}
{*           Io, Callisto                                *}
{*********************************************************}
