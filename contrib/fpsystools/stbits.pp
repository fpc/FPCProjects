...
{*********************************************************}
{* TurboPower SysTools for Kylix: StBits.pas 1.01        *}
{*********************************************************}
...
type
  ...
  protected
    ...
    ////TL Dupe ID:Max... changed to Max1
    procedure btSetMax(Max1 : LongInt);
    procedure btRecount;
  ...
  public
    ////TL Dupe ID:Max... changed to Max1
    constructor Create(Max1 : LongInt); virtual;
...
////TL Dupe ID:Max... changed to Max1
procedure TStBits.btSetMax(Max1 : LongInt);
var
...
////TL Dupe ID:Max... changed to Max1
constructor TStBits.Create(Max1 : LongInt);
begin
  {Validate size}
  if Max1 < 0 then
    RaiseContainerError(stscBadSize);
...
////TL added @ in the following 2 functions
...
////TL Added @ to StopImmediately in the following 4 functions
...
////TL Added @ to StopImmediately in the following 2 functions
