 ...
 * ***** END LICENSE BLOCK ***** *)
 ...
 Tom Lisjac <vlx@users.sourceforge.net> http://theseus.sf.net
   ...
   17-6-2003 status: Dispose and several typing errors need to be fixed

 *)

{*********************************************************}
{* TurboPower SysTools for Kylix: StToHTML.pas 1.01      *}
{*********************************************************}
{* SysTools: HTML Formatting routines and classes        *}
{*********************************************************}
...
begin
  ////TL!!! This will definitely need to be fixed: Dispose(Data);
end;
...
begin
  ...
  ////TL: Added "@" sign prefixes to the to the following 4 lines
  ...
  try
    ...
    begin
      ////TL!! Added "@" sign prefixes to the to the following. There is still
      ////TL!! a type related issue with the function calls that are commented out
