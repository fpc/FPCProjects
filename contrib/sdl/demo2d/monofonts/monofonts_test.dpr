...
begin
 ...
 New(Font, Initialize('fonts/times new roman regular 8.bmp'));
 ...
 Font.LoadFont('fonts/ms sans serif regular 10.bmp');
 ...
 // Change font again
 Font.LoadFont('fonts/copperplate gothic bold 16.bmp');
