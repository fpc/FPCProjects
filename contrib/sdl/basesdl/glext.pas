...
{$IFDEF Win32}
// Declared in Windows unit as well in FPC; but declared here as well, to be fully compatible to upstream version  - sg
function wglGetProcAddress(proc: PChar): Pointer; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF} external 'OpenGL32.dll';
{$ELSE}
...
var
  ...
  wglSaveBufferRegionARB: function(hRegion: THandle; x: GLint; y: GLint; width: GLint; height: GLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglRestoreBufferRegionARB: function(hRegion: THandle; x: GLint; y: GLint; width: GLint; height: GLint; xSrc: GLint; ySrc: GLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
...
var
  glFogCoordfEXfloat: procedure(coord: GLfloat); {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  glFogCoorddEXdouble: procedure(coord: GLdouble); {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  glFogCoordfvEXfloat: procedure(coord: GLfloat); {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  glFogCoorddvEXdouble: procedure(coord: GLdouble); {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
...
var
  wglCreateImageBufferI3D: function(hDC: HDC; dwSize: LongWord; uFlags: LongWord): PGLvoid; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglDestroyImageBufferI3D: function(hDC: HDC; pAddress: PGLvoid): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglAssociateImageBufferEventsI3D: function(hdc: HDC; pEvent: PHandle; pAddress: PGLvoid; pSize: PLongWord; count: LongWord): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglReleaseImageBufferEventsI3D: function(hdc: HDC; pAddress: PGLvoid; count: LongWord): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}

function Load_WGL_I3D_image_buffer: Boolean;

//***** WGL_I3D_swap_frame_lock *****//
var
  wglEnableFrameLockI3D: function: GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglDisableFrameLockI3D: function: GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglIsEnabledFrameLockI3D: function(pFlag: PGLBoolean): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglQueryFrameLockMasterI3D: function(pFlag: PGLBoolean): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}

function Load_WGL_I3D_swap_frame_lock: Boolean;

//***** WGL_I3D_swap_frame_usage *****//
var
  wglGetFrameUsageI3D: function(pUsage: PGLfloat): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglBeginFrameTrackingI3D: function: GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglEndFrameTrackingI3D: function: GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglQueryFrameTrackingI3D: function(pFrameCount: PLongWord; pMissedFrames: PLongWord; pLastMissedUsage: PGLfloat): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
...
var
  wglGetPixelFormatAttribivARB: function(hdc: HDC; iPixelFormat: GLint; iLayerPlane: GLint; nAttributes: GLuint; const piAttributes: PGLint; piValues: PGLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglGetPixelFormatAttribfvARB: function(hdc: HDC; iPixelFormat: GLint; iLayerPlane: GLint; nAttributes: GLuint; const piAttributes: PGLint; pfValues: PGLfloat): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglChoosePixelFormatARB: function(hdc: HDC; const piAttribIList: PGLint; const pfAttribFList: PGLfloat; nMaxFormats: GLuint; piFormats: PGLint; nNumFormats: PGLuint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
...
var
  wglMakeContextCurrentARB: function(hDrawDC: HDC; hReadDC: HDC; hglrc: HGLRC): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
...
var
  ...
  wglDestroyPbufferARB: function(hPbuffer: THandle): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglQueryPbufferARB: function(hPbuffer: THandle; iAttribute: GLint; piValue: PGLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}

function Load_WGL_ARB_pbuffer: Boolean;

//***** WGL_EXT_swap_control *****//
var
  wglSwapIntervalEXT: function(interval: GLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
...
const
  ...
  WGL_AUX9_ARB = $2090;
var
  wglBindTexImageARB: function(hPbuffer: THandle; iBuffer: GLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglReleaseTexImageARB: function(hPbuffer: THandle; iBuffer: GLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglSetPbufferAttribARB: function(hPbuffer: THandle; const piAttribList: PGLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
...
var
  wglMakeContextCurrentEXT: function(hDrawDC: HDC; hReadDC: HDC; hglrc: HGLRC): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
...
var
  ...
  wglDestroyPbufferEXT: function(hPbuffer: THandle): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglQueryPbufferEXT: function(hPbuffer: THandle; iAttribute: GLint; piValue: PGLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
...
var
  wglGetPixelFormatAttribivEXT: function(hdc: HDC; iPixelFormat: GLint; iLayerPlane: GLint; nAttributes: GLuint; piAttributes: PGLint; piValues: PGLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglGetPixelFormatAttribfvEXT: function(hdc: HDC; iPixelFormat: GLint; iLayerPlane: GLint; nAttributes: GLuint; piAttributes: PGLint; pfValues: PGLfloat): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglChoosePixelFormatEXT: function(hdc: HDC; const piAttribIList: PGLint; const pfAttribFList: PGLfloat; nMaxFormats: GLuint; piFormats: PGLint; nNumFormats: PGLuint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
...
var
  wglGetDigitalVideoParametersI3D: function(hDC: HDC; iAttribute: GLint; piValue: PGLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglSetDigitalVideoParametersI3D: function(hDC: HDC; iAttribute: GLint; const piValue: PGLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
...
var
  wglGetGammaTableParametersI3D: function(hDC: HDC; iAttribute: GLint; piValue: PGLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglSetGammaTableParametersI3D: function(hDC: HDC; iAttribute: GLint; const piValue: PGLint): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglGetGammaTableI3D: function(hDC: HDC; iEntries: GLint; puRed: PGLUSHORT; puGreen: PGLUSHORT; puBlue: PGLUSHORT): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglSetGammaTableI3D: function(hDC: HDC; iEntries: GLint; const puRed: PGLUSHORT; const puGreen: PGLUSHORT; const puBlue: PGLUSHORT): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
...
var
  wglEnableGenlockI3D: function(hDC: HDC): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglDisableGenlockI3D: function(hDC: HDC): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglIsEnabledGenlockI3D: function(hDC: HDC; pFlag: PGLBoolean): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglGenlockSourceI3D: function(hDC: HDC; uSource: GLUInt): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglGetGenlockSourceI3D: function(hDC: HDC; uSource: PGLUInt): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglGenlockSourceEdgeI3D: function(hDC: HDC; uEdge: GLUInt): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglGetGenlockSourceEdgeI3D: function(hDC: HDC; uEdge: PGLUInt): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglGenlockSampleRateI3D: function(hDC: HDC; uRate: GLUInt): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglGetGenlockSampleRateI3D: function(hDC: HDC; uRate: PGLUInt): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglGenlockSourceDelayI3D: function(hDC: HDC; uDelay: GLUInt): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglGetGenlockSourceDelayI3D: function(hDC: HDC; uDelay: PGLUInt): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
  wglQueryGenlockMaxSourceDelayI3D: function(hDC: HDC; uMaxLineDelay: PGLUInt; uMaxPixelDelay: PGLUInt): GLBoolean; {$IFDEF WIN32}stdcall;{$ELSE}cdecl;{$ENDIF}
...
function wglGetProcAddress(proc: PChar): Pointer;
begin
  Result := GetModuleSymbol(LibGL, proc);
end;
{$ENDIF}
