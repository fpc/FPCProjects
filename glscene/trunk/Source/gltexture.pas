	...
	TGLTexture = class (TGLUpdateAbleObject)
      ...
      procedure SetBorder(const val : GLuint);
		...
		public
         ...
         procedure ApplyAsTexture2(var rci : TRenderContextInfo; textureMatrix: PMatrix= nil);
         procedure UnApplyAsTexture2(var rci : TRenderContextInfo; reloadIdentityTextureMatrix: boolean);
         {: N=1 for TEXTURE0_ARB, N=2 for TEXTURE1_ARB, etc. }
         procedure ApplyAsTextureN(n : Integer; var rci : TRenderContextInfo; textureMatrix: PMatrix= nil);
         procedure UnApplyAsTextureN(n : Integer; var rci : TRenderContextInfo; reloadIdentityTextureMatrix: boolean);
...
// ApplyAsTexture2
//
procedure TGLTexture.ApplyAsTexture2(var rci : TRenderContextInfo; textureMatrix: PMatrix= nil);
begin
...
// UnApplyAsTexture2
//
procedure TGLTexture.UnApplyAsTexture2(var rci : TRenderContextInfo; reloadIdentityTextureMatrix: boolean);
begin
...
// ApplyAsTextureN
//
procedure TGLTexture.ApplyAsTextureN(n : Integer; var rci : TRenderContextInfo; textureMatrix: PMatrix= nil);
var
   m : TMatrix;
begin
   if not Disabled then begin
...
// UnApplyAsTextureN
//
procedure TGLTexture.UnApplyAsTextureN(n : Integer; var rci : TRenderContextInfo; reloadIdentityTextureMatrix: boolean);
begin
   glActiveTextureARB(GL_TEXTURE0_ARB+n-1);
   UnApplyMappingMode;
   if (Image.NativeTextureTarget<>GL_TEXTURE_2D)
      or reloadIdentityTextureMatrix then begin
      glMatrixMode(GL_TEXTURE);
      glLoadIdentity;
      glMatrixMode(GL_MODELVIEW);
   end;
