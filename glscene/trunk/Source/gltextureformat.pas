...
const
  ...
  cTextureFormatToOpenGL: array[tfRGB..high(TGLInternalFormat), 0..2] of Integer
    ...
    (GL_INTENSITY32UI_EXT, GL_LUMINANCE_INTEGER, GL_UNSIGNED_INT),
    (GL_LUMINANCE32UI_EXT, GL_LUMINANCE_INTEGER, GL_UNSIGNED_INT),
    (GL_LUMINANCE_ALPHA32UI_EXT, GL_LUMINANCE_ALPHA_INTEGER, GL_UNSIGNED_INT),
    (GL_RGBA16UI, GL_RGBA_INTEGER, GL_UNSIGNED_SHORT),
    (GL_RGB16UI, GL_RGB_INTEGER, GL_UNSIGNED_SHORT),
    (GL_ALPHA16UI_EXT, GL_ALPHA_INTEGER, GL_UNSIGNED_SHORT),
    (GL_INTENSITY16UI_EXT, GL_LUMINANCE_INTEGER, GL_UNSIGNED_SHORT),
    (GL_LUMINANCE16UI_EXT, GL_LUMINANCE_INTEGER, GL_UNSIGNED_SHORT),
    (GL_LUMINANCE_ALPHA16UI_EXT, GL_LUMINANCE_ALPHA_INTEGER, GL_UNSIGNED_SHORT),
    (GL_RGBA8UI, GL_RGBA_INTEGER, GL_UNSIGNED_BYTE),
    (GL_RGB8UI, GL_RGB_INTEGER, GL_UNSIGNED_BYTE),
    (GL_ALPHA8UI_EXT, GL_ALPHA_INTEGER, GL_UNSIGNED_BYTE),
    (GL_INTENSITY8UI_EXT, GL_LUMINANCE_INTEGER, GL_UNSIGNED_BYTE),
    (GL_LUMINANCE8UI_EXT, GL_LUMINANCE_INTEGER, GL_UNSIGNED_BYTE),
    (GL_LUMINANCE_ALPHA8UI_EXT, GL_LUMINANCE_ALPHA_INTEGER, GL_UNSIGNED_BYTE),
    (GL_RGBA32I, GL_RGBA_INTEGER, GL_INT),
    (GL_RGB32I, GL_RGB_INTEGER, GL_INT),
    (GL_ALPHA32I_EXT, GL_ALPHA_INTEGER, GL_INT),
    (GL_INTENSITY32I_EXT, GL_LUMINANCE_INTEGER, GL_INT),
    (GL_LUMINANCE32I_EXT, GL_LUMINANCE_INTEGER, GL_INT),
    (GL_LUMINANCE_ALPHA32I_EXT, GL_LUMINANCE_ALPHA_INTEGER, GL_INT),
    (GL_RGBA16I, GL_RGBA_INTEGER, GL_SHORT),
    (GL_RGB16I, GL_RGB_INTEGER, GL_SHORT),
    (GL_ALPHA16I_EXT, GL_ALPHA_INTEGER, GL_SHORT),
    (GL_INTENSITY16I_EXT, GL_LUMINANCE_INTEGER, GL_SHORT),
    (GL_LUMINANCE16I_EXT, GL_LUMINANCE_INTEGER, GL_SHORT),
    (GL_LUMINANCE_ALPHA16I_EXT, GL_LUMINANCE_ALPHA_INTEGER, GL_SHORT),
...
begin
  case colorFormat of
    ...
    GL_LUMINANCE_INTEGER: components := 1;
    GL_LUMINANCE_ALPHA_INTEGER: components := 2;
