...
begin
   ...
   GetOrCreateSoundEmitter(Sphere).Source.SoundLibrary:=GLSoundLibrary;
   GetOrCreateSoundEmitter(Sphere).Source.SoundName:='drumloop.wav';
   GetOrCreateSoundEmitter(Sphere).Source.NBLoops:=99;
