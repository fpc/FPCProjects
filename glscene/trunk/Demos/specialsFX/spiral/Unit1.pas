...
//    GLFullScreenViewer: TGLFullScreenViewer;
    ...
    procedure GLCadencerProgress(Sender: TObject; const deltaTime,
      newTime: Double);
    procedure GLFullScreenViewerClick(Sender: TObject);
    procedure PFXRingCreateParticle(Sender: TObject; aParticle: TGLParticle);
    procedure PFXSpiralCreateParticle(Sender: TObject; aParticle: TGLParticle);
...
procedure TForm1.GLFullScreenViewerClick(Sender: TObject);
begin

end;

procedure TForm1.PFXRingCreateParticle(Sender: TObject; aParticle: TGLParticle);
begin

end;

procedure TForm1.PFXSpiralCreateParticle(Sender: TObject; aParticle: TGLParticle
  );
begin
