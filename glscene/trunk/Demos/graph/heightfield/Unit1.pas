...
uses
  LCLIntf, Messages, SysUtils, Classes, Graphics, Controls, Forms, StdCtrls,
  ComCtrls, GLGraph, GLObjects, GLMisc, ExtCtrls, GLTexture,
  GLCadencer, VectorGeometry, GLWin32Viewer, LResources, GLScene;
