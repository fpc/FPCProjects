  ...
  GDB_FILE *stream;
{
  ...
  fprintf_filtered (stream, "GNU gdb %s modified for Pascal language support\n", version);

  /* Second line is a copyright notice. */

  fprintf_filtered (stream, "Copyright 1998 Free Software Foundation, Inc.\n");
  fprintf_filtered (stream, "Pascal modifications by Pierre Muller and Peter Vreman\n");
