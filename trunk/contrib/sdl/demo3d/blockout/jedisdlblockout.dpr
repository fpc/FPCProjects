...
{$ENDIF}
{$IFDEF WIN32}
  Colors: array[1..12, 0..3] of GLfloat =
  ((1, 0, 0, 0.5), (0, 1, 0, 0.5), (0, 0, 1, 0.5), (1, 0, 1, 0.5),
    (1, 1, 0, 0.5), (0, 1, 1, 0.5), (1, 1, 1, 0.5), (1, 0.5, 0.5, 0.5),
    (0.5, 1, 0.5, 0.5), (0.5, 0.5, 1, 0.5), (1, 0.5, 1, 0.5),
    (1, 0.5, 0.1, 0.5));
  ...
  (((2, 10, 3), (3, 10, 3), (3, 10, 4), (4, 10, 3)),
    ...
    ((3, 9, 3), (3, 10, 3), (3, 10, 4), (4, 10, 4)),
    ((3, 9, 4), (3, 10, 3), (3, 10, 4), (4, 10, 4)));
  LPos: array[0..2, 0..3] of GLfloat = ((2, 0, 0, 1), (0, 2, 0, 1), (0, 0, 2,
    1));
  LColor: array[0..2, 0..3] of GLfloat = ((1, 0, 0, 0.5), (0, 0, 1, 0.5), (0,
    1, 0, 0.5));
{$ENDIF}
...
procedure DrawBlock(xp, yp, zp: single; c: byte);
begin
  with scene do
  begin
    if c = 0 then
...
{
  $Log$
  Revision 1.1  2004/04/04 11:21:12  marco
   * first 3d demo: blockout
