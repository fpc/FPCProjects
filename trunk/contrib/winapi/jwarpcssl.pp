...
{$IFDEF UNICODE}
function RpcCertGeneratePrincipalName(Context: PCCERT_CONTEXT; Flags: DWORD; out pBuffer: PWideChar): RPC_STATUS; stdcall;
{$ELSE}
function RpcCertGeneratePrincipalName(Context: PCCERT_CONTEXT; Flags: DWORD; out pBuffer: PAnsiChar): RPC_STATUS; stdcall;
{$ENDIF}
...
{$IFDEF UNICODE}
function RpcCertGeneratePrincipalName; external rpclib name 'RpcCertGeneratePrincipalNameW';
{$ELSE}
function RpcCertGeneratePrincipalName; external rpclib name 'RpcCertGeneratePrincipalNameA';
{$ENDIF}
