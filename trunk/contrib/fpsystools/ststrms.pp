 ...
 * ***** END LICENSE BLOCK ***** *)
 ...
 Tom Lisjac <vlx@users.sourceforge.net> http://theseus.sf.net
   ...
   17-6-2003 status: compiles ok with added MaxBytes and TByteArray declarations... ready for testing

 *)

{*********************************************************}
{* TurboPower SysTools for Kylix: StStrms.pas 1.01       *}
{*********************************************************}
{* SysTools: Stream Based Classes                        *}
{*********************************************************}
...
MaxBytes = 128*1024*1024; ////TL Added declaration

type
  TStMemSize = word;
  
  TByteArray = ARRAY [0..MaxBytes-1] Of Byte; ////TL Added declaration
