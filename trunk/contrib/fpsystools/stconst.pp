...
{*********************************************************}
{* TurboPower SysTools for Kylix: StConst.pas 1.01       *}
{*********************************************************}
{* SysTools: Resource constants for SysTools             *}
{*********************************************************}
...
resourcestring
  ...
  stscExprCommExpS               = 'Comma expected';
  ...
  stscInvalidLengthS             = 'Invalid length for POSTNET';
...
const
  SysToolsStrArray : array [0..181] of StStrRec = (
 ...
 (ID: stscExprCommExp; Str: stscExprCommExpS),  {comma expected}
