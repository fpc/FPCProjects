...
Legal issues: Copyright (C) 2001 by François PIETTE
...
uses
    Windows, Classes, SysUtils, Messages, SmtpProt;

const
  ConSmtpVersion = 102;
  CopyRight      = ' ConSmtp (c) 2002-2003 by Francois PIETTE. V1.02';
...
begin
    ...
    FSmtpCli.RcptName.Add('francois.piette@overbyte.be');   { This is CCi }
...
begin
    if LineNum > FMessageBody.count then
        ...
        StrPLCopy(MsgLine, FMessageBody.Strings[LineNum - 1], MaxLen - 1);
end;
