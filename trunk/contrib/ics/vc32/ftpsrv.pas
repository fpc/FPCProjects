...
const
    ...
    CopyRight : String       = ' TFtpServer (c) 1998-2003 F. Piette V1.26 ';
...
{$ENDIF}
    ...
    protected
        ...
        FClientNum              : LongInt;
        FMaxClients             : LongInt;
        FCmdTable               : array [0..32] of TFtpSrvCommandTableItem;
        FLastCmd                : Integer;
        ...
        procedure ClientStorDataAvailable(Sender: TObject; AError  : word);
        procedure ClientRetrSessionConnected(Sender : TObject; AError  : Word);
...
{$IFDEF VER80}
    ReallocMem(FPasvPortTable, FPasvPortTableSize, NewValue);
{$ELSE}
