...
COPY webclient/config/nginx.crt /etc/nginx/ssl/nginx.crt
COPY webclient/config/nginx.key /etc/nginx/ssl/nginx.key
COPY webclient/config/configure_and_run_nginx.sh configure_and_run_nginx.sh
...
CMD ["/bin/bash", "configure_and_run_nginx.sh"]