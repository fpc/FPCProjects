...
function sendto(s: TSocket; const Buf; len, flags: Integer; var addrto: TSockAddr; tolen: Integer): Integer; stdcall;
...
function accept;        stdcall;external WINSOCK2_DLL name 'accept';
function bind;          stdcall;external WINSOCK2_DLL name 'bind';
function closesocket;   stdcall;external WINSOCK2_DLL name 'closesocket';
function connect;       stdcall;external WINSOCK2_DLL name 'connect';
function ioctlsocket;   stdcall;external WINSOCK2_DLL name 'ioctlsocket';
function getpeername;   stdcall;external WINSOCK2_DLL name 'getpeername';
function getsockname;   stdcall;external WINSOCK2_DLL name 'getsockname';
function getsockopt;    stdcall;external WINSOCK2_DLL name 'getsockopt';
function htonl;         stdcall;external WINSOCK2_DLL name 'htonl';
function htons;         stdcall;external WINSOCK2_DLL name 'htons';
function inet_addr;     stdcall;external WINSOCK2_DLL name 'inet_addr';
function inet_ntoa;     stdcall;external WINSOCK2_DLL name 'inet_ntoa';
function listen;        stdcall;external WINSOCK2_DLL name 'listen';
function ntohl;         stdcall;external WINSOCK2_DLL name 'ntohl';
function ntohs;         stdcall;external WINSOCK2_DLL name 'ntohs';
function recv;          stdcall;external WINSOCK2_DLL name 'recv';
function recvfrom;      stdcall;external WINSOCK2_DLL name 'recvfrom';
function select;        stdcall;external WINSOCK2_DLL name 'select';
function send;          stdcall;external WINSOCK2_DLL name 'send';
function sendto;        stdcall;external WINSOCK2_DLL name 'sendto';
function setsockopt;    stdcall;external WINSOCK2_DLL name 'setsockopt';
function shutdown;      stdcall;external WINSOCK2_DLL name 'shutdown';
function socket;        stdcall;external WINSOCK2_DLL name 'socket';
function gethostbyaddr; stdcall;external WINSOCK2_DLL name 'gethostbyaddr';
function gethostbyname; stdcall;external WINSOCK2_DLL name 'gethostbyname';
function gethostname;   stdcall;external WINSOCK2_DLL name 'gethostname';
function getservbyport; stdcall;external WINSOCK2_DLL name 'getservbyport';
function getservbyname; stdcall;external WINSOCK2_DLL name 'getservbyname';
function getprotobynumber;      stdcall;external WINSOCK2_DLL name 'getprotobynumber';
function getprotobyname;        stdcall;external WINSOCK2_DLL name 'getprotobyname';
function WSAStartup;    stdcall;external WINSOCK2_DLL name 'WSAStartup';
function WSACleanup;    stdcall;external WINSOCK2_DLL name 'WSACleanup';
procedure WSASetLastError;      stdcall;external WINSOCK2_DLL name 'WSASetLastError';
function WSAGetLastError;       stdcall;external WINSOCK2_DLL name 'WSAGetLastError';
function WSAIsBlocking; stdcall;external WINSOCK2_DLL name 'WSAIsBlocking';
function WSAUnhookBlockingHook; stdcall;external WINSOCK2_DLL name 'WSAUnhookBlockingHook';
function WSASetBlockingHook;    stdcall;external WINSOCK2_DLL name 'WSASetBlockingHook';
function WSACancelBlockingCall; stdcall;external WINSOCK2_DLL name 'WSACancelBlockingCall';
function WSAAsyncGetServByName; stdcall;external WINSOCK2_DLL name 'WSAAsyncGetServByName';
function WSAAsyncGetServByPort; stdcall;external WINSOCK2_DLL name 'WSAAsyncGetServByPort';
function WSAAsyncGetProtoByName;        stdcall;external WINSOCK2_DLL name 'WSAAsyncGetProtoByName';
function WSAAsyncGetProtoByNumber;      stdcall;external WINSOCK2_DLL name 'WSAAsyncGetProtoByNumber';
function WSAAsyncGetHostByName; stdcall;external WINSOCK2_DLL name 'WSAAsyncGetHostByName';
function WSAAsyncGetHostByAddr; stdcall;external WINSOCK2_DLL name 'WSAAsyncGetHostByAddr';
function WSACancelAsyncRequest; stdcall;external WINSOCK2_DLL name 'WSACancelAsyncRequest';
function WSAAsyncSelect;        stdcall;external WINSOCK2_DLL name 'WSAAsyncSelect';
function __WSAFDIsSet;  stdcall;external WINSOCK2_DLL name '__WSAFDIsSet';

{       WinSock 2 API new function prototypes }
function WSAAccept;     stdcall;external WINSOCK2_DLL name 'WSAAccept';
function WSACloseEvent; stdcall;external WINSOCK2_DLL name 'WSACloseEvent';
function WSAConnect;    stdcall;external WINSOCK2_DLL name 'WSAConnect';
function WSACreateEvent;        stdcall;external WINSOCK2_DLL name 'WSACreateEvent';
function WSADuplicateSocketA;   stdcall;external WINSOCK2_DLL name 'WSADuplicateSocketA';
function WSADuplicateSocketW;   stdcall;external WINSOCK2_DLL name 'WSADuplicateSocketW';
function WSAEnumNetworkEvents;  stdcall;external WINSOCK2_DLL name 'WSAEnumNetworkEvents';
function WSAEnumProtocolsA;     stdcall;external WINSOCK2_DLL name 'WSAEnumProtocolsA';
function WSAEnumProtocolsW;     stdcall;external WINSOCK2_DLL name 'WSAEnumProtocolsW';
function WSAEventSelect;        stdcall;external WINSOCK2_DLL name 'WSAEventSelect';
function WSAGetOverlappedResult;        stdcall;external WINSOCK2_DLL name 'WSAGetOverlappedResult';
function WSAGetQosByName;       stdcall;external WINSOCK2_DLL name 'WSAGetQOSByName';
function WSAhtonl;      stdcall;external WINSOCK2_DLL name 'WSAHtonl';
function WSAhtons;      stdcall;external WINSOCK2_DLL name 'WSAHtons';
function WSAIoctl;      stdcall;external WINSOCK2_DLL name 'WSAIoctl';
function WSAJoinLeaf;   stdcall;external WINSOCK2_DLL name 'WSAJoinLeaf';
function WSANtohl;      stdcall;external WINSOCK2_DLL name 'WSANtohl';
function WSANtohs;      stdcall;external WINSOCK2_DLL name 'WSANtohs';
function WSARecv;       stdcall;external WINSOCK2_DLL name 'WSARecv';
function WSARecvDisconnect;     stdcall;external WINSOCK2_DLL name 'WSARecvDisconnect';
function WSARecvFrom;   stdcall;external WINSOCK2_DLL name 'WSARecvFrom';
function WSAResetEvent; stdcall;external WINSOCK2_DLL name 'WSAResetEvent';
function WSASend;       stdcall;external WINSOCK2_DLL name 'WSASend';
function WSASendDisconnect;     stdcall;external WINSOCK2_DLL name 'WSASendDisconnect';
function WSASendTo;     stdcall;external WINSOCK2_DLL name 'WSASendTo';
function WSASetEvent;   stdcall;external WINSOCK2_DLL name 'WSASetEvent';
function WSASocketA;    stdcall;external WINSOCK2_DLL name 'WSASocketA';
function WSASocketW;    stdcall;external WINSOCK2_DLL name 'WSASocketW';
function WSAWaitForMultipleEvents;      stdcall;external WINSOCK2_DLL name 'WSAWaitForMultipleEvents';
function WSAAddressToStringA;   stdcall;external WINSOCK2_DLL name 'WSAAddressToStringA';
function WSAAddressToStringW;   stdcall;external WINSOCK2_DLL name 'WSAAddressToStringW';
function WSAStringToAddressA;   stdcall;external WINSOCK2_DLL name 'WSAStringToAddressA';
function WSAStringToAddressW;   stdcall;external WINSOCK2_DLL name 'WSAStringToAddressW';

{       Registration and Name Resolution API functions }
function WSALookupServiceBeginA;        stdcall;external WINSOCK2_DLL name 'WSALookupServiceBeginA';
function WSALookupServiceBeginW;        stdcall;external WINSOCK2_DLL name 'WSALookupServiceBeginW';
function WSALookupServiceNextA; stdcall;external WINSOCK2_DLL name 'WSALookupServiceNextA';
function WSALookupServiceNextW; stdcall;external WINSOCK2_DLL name 'WSALookupServiceNextW';
function WSALookupServiceEnd;   stdcall;external WINSOCK2_DLL name 'WSALookupServiceEnd';
function WSAInstallServiceClassA;       stdcall;external WINSOCK2_DLL name 'WSAInstallServiceClassA';
function WSAInstallServiceClassW;       stdcall;external WINSOCK2_DLL name 'WSAInstallServiceClassW';
function WSARemoveServiceClass; stdcall;external WINSOCK2_DLL name 'WSARemoveServiceClass';
function WSAGetServiceClassInfoA;       stdcall;external WINSOCK2_DLL name 'WSAGetServiceClassInfoA';
function WSAGetServiceClassInfoW;       stdcall;external WINSOCK2_DLL name 'WSAGetServiceClassInfoW';
function WSAEnumNameSpaceProvidersA;    stdcall;external WINSOCK2_DLL name 'WSAEnumNameSpaceProvidersA';
function WSAEnumNameSpaceProvidersW;    stdcall;external WINSOCK2_DLL name 'WSAEnumNameSpaceProvidersW';
function WSAGetServiceClassNameByClassIdA;      stdcall;external WINSOCK2_DLL name 'WSAGetServiceClassNameByClassIdA';
function WSAGetServiceClassNameByClassIdW;      stdcall;external WINSOCK2_DLL name 'WSAGetServiceClassNameByClassIdW';
function WSASetServiceA;        stdcall;external WINSOCK2_DLL name 'WSASetServiceA';
function WSASetServiceW;        stdcall;external WINSOCK2_DLL name 'WSASetServiceW';

{$IFDEF UNICODE}
function WSADuplicateSocket;    stdcall;external WINSOCK2_DLL name 'WSADuplicateSocketW';
function WSAEnumProtocols;      stdcall;external WINSOCK2_DLL name 'WSAEnumProtocolsW';
function WSASocket;     stdcall;external WINSOCK2_DLL name 'WSASocketW';
function WSAAddressToString;    stdcall;external WINSOCK2_DLL name 'WSAAddressToStringW';
function WSAStringToAddress;    stdcall;external WINSOCK2_DLL name 'WSAStringToAddressW';
function WSALookupServiceBegin; stdcall;external WINSOCK2_DLL name 'WSALookupServiceBeginW';
function WSALookupServiceNext;  stdcall;external WINSOCK2_DLL name 'WSALookupServiceNextW';
function WSAInstallServiceClass;        stdcall;external WINSOCK2_DLL name 'WSAInstallServiceClassW';
function WSAGetServiceClassInfo;        stdcall;external WINSOCK2_DLL name 'WSAGetServiceClassInfoW';
function WSAEnumNameSpaceProviders;     stdcall;external WINSOCK2_DLL name 'WSAEnumNameSpaceProvidersW';
function WSAGetServiceClassNameByClassId;       stdcall;external WINSOCK2_DLL name 'WSAGetServiceClassNameByClassIdW';
function WSASetService; stdcall;external WINSOCK2_DLL name 'WSASetServiceW';
{$ELSE}
function WSADuplicateSocket;    stdcall;external WINSOCK2_DLL name 'WSADuplicateSocketA';
function WSAEnumProtocols;      stdcall;external WINSOCK2_DLL name 'WSAEnumProtocolsA';
function WSASocket;     stdcall;external WINSOCK2_DLL name 'WSASocketA';
function WSAAddressToString;    stdcall;external WINSOCK2_DLL name 'WSAAddressToStringA';
function WSAStringToAddress;    stdcall;external WINSOCK2_DLL name 'WSAStringToAddressA';
function WSALookupServiceBegin; stdcall;external WINSOCK2_DLL name 'WSALookupServiceBeginA';
function WSALookupServiceNext;  stdcall;external WINSOCK2_DLL name 'WSALookupServiceNextA';
function WSAInstallServiceClass;        stdcall;external WINSOCK2_DLL name 'WSAInstallServiceClassA';
function WSAGetServiceClassInfo;        stdcall;external WINSOCK2_DLL name 'WSAGetServiceClassInfoA';
function WSAEnumNameSpaceProviders;     stdcall;external WINSOCK2_DLL name 'WSAEnumNameSpaceProvidersA';
function WSAGetServiceClassNameByClassId;       stdcall;external WINSOCK2_DLL name 'WSAGetServiceClassNameByClassIdA';
function WSASetService; stdcall;external WINSOCK2_DLL name 'WSASetServiceA';
{$ENDIF}
